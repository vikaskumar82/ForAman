...
<!-- End Google Tag Manager -->
    ...
    <meta name="description" content="Need emergency dental care, wisdom teeth removal, dental checkups, etc.? Don't waste time. Instead, make an Appointment with Seville Dental Clinic for better oral health.">
    <title>Make an Appointment with Dr. Vishal Panchhi - Seville Dental</title>
...
<link rel="canonical" href="https://sevilledentalclinic.com.au/make-an-appointment.html" />
<script src="js/seville.js"></script>

  <script>
    function displayDivDemo(id, elementValue) {
       document.getElementById(id).style.display = elementValue.value == 6 ? 'block' : 'none';
    }
 </script>
 <style>
  #hideValuesOnSelect {
...
<div id="headerContent"></div>
  ...
  <div class="carousel-inner" style="height:60vh">
    <div class="carousel-item item22 active">
		<div class="carousel-caption">
		 <h2 class="animated slideInDown" style="animation-delay: 0.3s;">Make An Appointment</h2>
               </div>
    </div>
     </div>
	  </section>
	  ...
	  <section id="aboutus">
		  <div class="container-fluid">
			 ...
			 <div class="col-lg-4"> <img src="images/1.jpeg" width="500" height="300">
			 <h2>Seville Dental Clinic</h2><br><span style="font-size:22px; font-family:Arial; font-weight:normal; color:#666666">Shop 13, 547-567<br>Warburton Highway<br>Seville VIC 3139<br>Australia</span><br>
			 <span style="color:#FF3300; font-weight:bold; font-size:20px">Phone : </span><span style="font-family:Arial; font-size:16px">(03) 5964 4340</span><br><br>
			 <div align="center" style="color:#FF3300; font-weight:bold; background-color:#FF3333; color:#FFFFFF; font-size:20px">OFFICE HOURS : </div>
			 <table class="table">
    <thead>
      <tr>
        <th>DAY</th>
    ...
    <tbody>
	  ...
	  <tr>
        ...
        <td>Closed</td>
				  ...
				  <div class="col-lg-7 offset-lg-1">
				   <h2 align="center" style="font-weight:normal; font-family:Arial"><br>Make An Appointment</h2><br>
				  <div style="height:20px">Fields marked with an * are required</div>			<br>	 
					  <form action="mail1.php" method="post" role="form" class="contactForm">
      ...
      <input type="radio" name="patient" value="1">&nbsp;&nbsp;Returning Patient    </label>&nbsp;&nbsp;<br><br>
				...
				<label><b> PHONE:</b></label>
                 <p>Please enter your contact number without spaces</p>
                  <input type="phone" class="form-control" name="phone" id="phone" placeholder="Your Number" data-rule="phone" data-msg="Please enter phone Number" />
                  <div class="validation"></div>
                </div>
                <div class="form-group">
				<label><b> PREFERRED DAY & TIME :</b></label>
     ...
     <input class="form-control" id="date" name="date" placeholder="MM/DD/YYYY" type="text">
                ...
                <div class="form-group">
                  <label><b>Which of our services are you interested in:</b></label><br>
                  <select name="reason" onchange="displayDivDemo('hideValuesOnSelect', this)">
                  <option value="0">Select Reason</option>
                  <?php require_once("emailsRepo.php");

$emails = new emailsRepo();

$reasons=$emails->reschedule(rid);
//echo $reasons[0];
/*foreach($reasons as $i) {
    //echo "<option value=" . $i["id"] . ">" . $i["reason_name"] ."</option>";
...
?>
    ...
    <input type="email" class="form-control" id="youremail" placeholder="Your Email">
	  ...
	  &copy; 2019 www.SevilleDentalClinic.com.au ALL RIGHTS ARE RESERVED.<br>Designed by <a href="http://bsitsolutions.com.au/" style="color:#33FFFF; text-decoration:none" target="_blank">BSIT SOLUTIONS</a></div>
	</div>
	</div>
