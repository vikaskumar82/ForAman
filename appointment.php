...
<script>
  ...
  <script>
    function displayDivDemo(id, elementValue) {
       document.getElementById(id).style.display = elementValue.value == 5 ? 'block' : 'none';
    ...
    <tbody>
	  ...
	  <tr>
        ...
        <td>Closed</td>
            ...
            <?php 
            include('./appointment/appointment-form.php');
